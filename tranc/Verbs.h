...
#define HDA_CONFIG_DEFAULTCONF_CONNECTIVITY_JACK		(0u<<30)
#define HDA_CONFIG_DEFAULTCONF_CONNECTIVITY_NONE		(1u<<30)
#define HDA_CONFIG_DEFAULTCONF_CONNECTIVITY_FIXED		(2u<<30)
#define HDA_CONFIG_DEFAULTCONF_CONNECTIVITY_BOTH		(3u<<30)

#define HDA_CONFIG_DEFAULTCONF_DEVICE_LINE_OUT			(0u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_SPEAKER			(1u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_HP_OUT			(2u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_CD				(3u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_SPDIF_OUT			(4u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_DIGITAL_OTHER_OUT	(5u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_MODEM_LINE		(6u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_MODEM_HANDSET		(7u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_LINE_IN			(8u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_AUX				(9u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_MIC_IN			(10u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_TELEPHONY			(11u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_SPDIF_IN			(12u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_DIGITAL_OTHER_IN	(13u<<20)
#define HDA_CONFIG_DEFAULTCONF_DEVICE_OTHER				(15u<<20)
