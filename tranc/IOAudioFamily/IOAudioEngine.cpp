...
// --- compat: macros removed from modern SDK headers ---
#include <IOKit/IOLib.h>
#ifndef IOMallocType
#define IOMallocType(T) (T *)IOMalloc(sizeof(T))
#endif
#ifndef IOFreeType
...
#endif
// --- compat: legacy require/check macros (AssertMacros.h no longer auto-included) ---
#include <AssertMacros.h>
#ifndef require
#define require(expr, label) \
