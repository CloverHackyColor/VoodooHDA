...
#define HDA_INTEL_CNLK        HDA_MODEL_CONSTRUCT(INTEL, 0xa348)
#define HDA_INTEL_CML_S       HDA_MODEL_CONSTRUCT(INTEL, 0xa3f0)
#define HDA_INTEL_CML_LP      HDA_MODEL_CONSTRUCT(INTEL, 0x02c8)
#define HDA_INTEL_CML_H       HDA_MODEL_CONSTRUCT(INTEL, 0x06c8)
#define HDA_INTEL_ICLK        HDA_MODEL_CONSTRUCT(INTEL, 0x34c8)
#define HDA_INTEL_JSL         HDA_MODEL_CONSTRUCT(INTEL, 0x4dc8)
#define HDA_INTEL_TGLLP       HDA_MODEL_CONSTRUCT(INTEL, 0xa0c8)
#define HDA_INTEL_DG1         HDA_MODEL_CONSTRUCT(INTEL, 0x4905)
#define HDA_INTEL_ADLS        HDA_MODEL_CONSTRUCT(INTEL, 0x7ad0)
#define HDA_INTEL_ADLP        HDA_MODEL_CONSTRUCT(INTEL, 0x51c8)
#define HDA_INTEL_ADLN        HDA_MODEL_CONSTRUCT(INTEL, 0x54c8)
#define HDA_INTEL_RPLS        HDA_MODEL_CONSTRUCT(INTEL, 0x7a50)
#define HDA_INTEL_RPLP        HDA_MODEL_CONSTRUCT(INTEL, 0x51ca)
#define HDA_INTEL_MTLP        HDA_MODEL_CONSTRUCT(INTEL, 0x7e28)
#define HDA_INTEL_ARLS        HDA_MODEL_CONSTRUCT(INTEL, 0x7728)
...
#define HDA_CODEC_INTELCFLK			HDA_CODEC_CONSTRUCT(INTEL, 0x280c)
#define HDA_CODEC_INTELCNLK			HDA_CODEC_CONSTRUCT(INTEL, 0x280d)
#define HDA_CODEC_INTELCMLK			HDA_CODEC_CONSTRUCT(INTEL, 0x280f)
#define HDA_CODEC_INTELICLK			HDA_CODEC_CONSTRUCT(INTEL, 0x2812)
#define HDA_CODEC_INTELTGLLK			HDA_CODEC_CONSTRUCT(INTEL, 0x2814)
#define HDA_CODEC_INTELADLK			HDA_CODEC_CONSTRUCT(INTEL, 0x2815)
#define HDA_CODEC_INTELRPLK			HDA_CODEC_CONSTRUCT(INTEL, 0x2816)
#define HDA_CODEC_INTELMTLK			HDA_CODEC_CONSTRUCT(INTEL, 0x2818)
